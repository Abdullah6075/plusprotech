...
import BrandsByCategory from './pages/BrandsByCategory'
  ...
  return (
    ...
    {/* <Navbar /> */}
      <Routes>
        ...
        <Route path='/category/:categoryId' element={<BrandsByCategory />} />
        <Route path='/category/:categoryId/brand/:brandId' element={<ModelsByCategory />} />
